            ...
            <VideoDetailsOptionsContainers>
              ...
              <NxtWatchContext.Consumer>
                {value => {
                  ...
                  const likedListIds = likedList.map(each => each.id)

                  const dislikedListIds = dislikedList.map(each => each.id)
                  ...
                  return (
                    <ButtonContainer>
                      <CustomizeButton
                        type="button"
                        onClick={addToLiked}
                        value={likedListIds.includes(id)}
                      >
                        <BiLike /> Like
                      </CustomizeButton>
                      <CustomizeButton
                        ...
                        value={dislikedListIds.includes(id)}
                      >
                        <BiDislike /> Dislike
                      </CustomizeButton>
